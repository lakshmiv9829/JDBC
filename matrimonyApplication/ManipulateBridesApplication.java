...
public class ManipulateBridesApplication {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < results.length; i++) {
			if (results[i] == 0) {
				System.out.println(brides.get(i).getName() +" "+ "bride is failed to create");

			} else {
				System.out.println(brides.get(i).getName() +" "+ "bride is created");
			}
		}
